    ...
    var handleUserChange = function(e) {
        ...
        if (userKey) {
            ...
            tweetBoxClickHandler = function(e) {
                 ...
                 * - After the first successful push, use userRef.once('value', callback) to get the user details, add those details to the tweet and push it to the user's timeline
                 * - The new timeline tweet will look like this: 
                    {
